    ...
    public function dashboard()
{
    ...
    return Cache::remember('admin_dashboard_stats', 600, function () {
        ...
        $activeSubscriptions = User::where('status', 'active')->count();
        ...
        $RecentIssues = EquipmentReport::orderBy('created_at', 'desc')->take(5)->get();


        $weeklySubscriptions = User::selectRaw('YEARWEEK(created_at, 1) as week, COUNT(*) as users_count')
